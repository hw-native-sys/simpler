...
class KernelCompiler:
    ...
    def compile_incore(
        ...
        from .pto_isa import assert_pto_isa_root_matches_pin  # noqa: PLC0415

        assert_pto_isa_root_matches_pin(pto_isa_root)
    ...
    def _compile_incore_sim(
        ...
        *,
        ...
        # Add PTO ISA header paths if provided (must match pto_isa.pin).
        if pto_isa_root:
            from .pto_isa import assert_pto_isa_root_matches_pin  # noqa: PLC0415
