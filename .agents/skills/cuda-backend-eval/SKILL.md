...
committed summary uses the `47ac2bb5` artifact names in
...
error counters, and generated report/chart presence. It is a local audit aid
under `tmp/`; do not commit it with raw benchmark or smoke data.
