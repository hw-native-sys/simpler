...
export NOTIF_PERF_CONSUMER_SO="$HERE/device-aicpu/build/libnotif_perf_consumer.so"
export NOTIF_PERF_PRODUCER_O="$HERE/device-aicore/build/notif_perf_producer.o"
# 50 samples instead of the default 100: enough for both subtests to report.
exec "$HERE/host/build/launch_notif_perf" "$DEV" 0 50
