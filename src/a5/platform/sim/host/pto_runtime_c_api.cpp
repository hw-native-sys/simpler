...
void *host_malloc(DeviceContextHandle ctx, size_t size) {
    (void)ctx;
    (void)size;
    LOG_ERROR("host_malloc is not supported on a5sim");
    return NULL;
}
...
void host_free(DeviceContextHandle ctx, void *host_ptr) {
    (void)ctx;
    (void)host_ptr;
    LOG_ERROR("host_free is not supported on a5sim");
}
...
int host_register_mapped(DeviceContextHandle ctx, void *host_ptr, size_t size, int device_id, void **dev_ptr) {
    ...
    LOG_ERROR("host_register_mapped is not supported on a5sim");
    return -1;
}
...
int host_unregister_mapped(DeviceContextHandle ctx, void *host_ptr, int device_id) {
    ...
    (void)host_ptr;
    (void)device_id;
    LOG_ERROR("host_unregister_mapped is not supported on a5sim");
    return -1;
}
