...
void Runtime::set_sdma_workspace_addr(uint64_t addr) { sdma_workspace_addr_ = addr; }
uint64_t Runtime::get_sdma_workspace_addr() const { return sdma_workspace_addr_; }
