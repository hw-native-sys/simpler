...
private:
    ...
    uint64_t sdma_workspace_addr_;  // SDMA workspace device address (0 = not available)
...
public:
    ...
    void set_sdma_workspace_addr(uint64_t addr);
    uint64_t get_sdma_workspace_addr() const;
