...
private:
    ...
    void* pto2_ring_slot_states_ptrs_[PTO2_MAX_RING_DEPTH];  // Per-ring PTO2TaskSlotState arrays (for profiling fallback)
...
public:
    ...
    void set_pto2_ring_slot_states_ptr(int ring_id, void* p);
