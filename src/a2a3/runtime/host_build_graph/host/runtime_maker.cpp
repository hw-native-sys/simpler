...
// Resolved orchestration .so entry points. prepare_callable_impl allocates one
...
int32_t run_host_orchestration(
    ...
    if (runtime->host_api.copy_to_device(device_sm, host_sm, sm_size) != 0) {
...
extern "C" int bind_callable_to_runtime_impl(
    ...
    // host_build_graph host-orch: prepare_callable_impl resolved the
    ...
    // state; the device boots scheduler-only. prepare_callable_impl guarantees
