...
extern "C" uint32_t runtime_hbg_kernel_architecture_impl(void) {
    return static_cast<uint32_t>(hbg::RuntimeArchitecture::A2A3);
}
...
int32_t hbg::get_graph_resource_requirements(
    ...
    next.layout = {HBG_RUNTIME_LAYOUT_ABI_VERSION, RuntimeArchitecture::A2A3, layout.task_capacity, layout.arena_size,
