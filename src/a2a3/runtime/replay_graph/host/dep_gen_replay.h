...
#ifndef SRC_A2A3_RUNTIME_REPLAY_GRAPH_HOST_DEP_GEN_REPLAY_H_
#define SRC_A2A3_RUNTIME_REPLAY_GRAPH_HOST_DEP_GEN_REPLAY_H_
 ...
 *
 * The task window is auto-derived from ring-0 local ids in the trace.
 *
...
#endif  // SRC_A2A3_RUNTIME_REPLAY_GRAPH_HOST_DEP_GEN_REPLAY_H_
