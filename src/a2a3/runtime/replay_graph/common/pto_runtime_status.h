 ...
 *
 * Shared error-code contract used inside the replay_graph runtime.
 */

#ifndef SRC_A2A3_RUNTIME_REPLAY_GRAPH_COMMON_PTO_RUNTIME_STATUS_H_
#define SRC_A2A3_RUNTIME_REPLAY_GRAPH_COMMON_PTO_RUNTIME_STATUS_H_
...
#define PTO2_ERROR_SCOPE_TASKS_OVERFLOW 10  // Retired; preserved for status ABI compatibility.
#define PTO2_ERROR_TENSORMAP_OVERFLOW 11    // Whole-graph TensorMap pool is undersized.
...
#endif  // SRC_A2A3_RUNTIME_REPLAY_GRAPH_COMMON_PTO_RUNTIME_STATUS_H_
