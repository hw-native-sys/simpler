...
unsigned long long g_nocache_offset = 0;
}  // namespace
...
void set_nocache_offset(unsigned long long offset) { g_nocache_offset = offset; }

unsigned long long get_nocache_offset() { return g_nocache_offset; }
