...
unsigned long long g_l2_cache_offset = 0;
}  // namespace
...
void set_dev_l2_cache_offset(unsigned long long offset) { g_l2_cache_offset = offset; }

unsigned long long get_dev_l2_cache_offset() { return g_l2_cache_offset; }
