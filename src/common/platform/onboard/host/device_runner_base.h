...
public:
    ...
    /**
     * Hand this run's host-orchestration mode to the resident collector under
     * the execution claim. `set_host_orchestrated` must precede collector
     * initialization because it controls the device orch phase-pool shape.
     */
