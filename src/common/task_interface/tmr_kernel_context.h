...
static_assert(sizeof(TmrContextRegistrationArgs) == 16);
...
static_assert(offsetof(TmrCallableRegistrationArgs, device_address) == 8);
static_assert(offsetof(TmrCallableRegistrationArgs, bytes) == 16);
static_assert(offsetof(TmrCallableRegistrationArgs, callable_id) == 24);
static_assert(offsetof(TmrCallableRegistrationArgs, reserved) == 28);
