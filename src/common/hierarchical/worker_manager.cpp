...
#if SIMPLER_HOST_STRACE
    // Read under admission, so the frame this dispatch just published is still
    // the endpoint's in-flight one: no later submission has replaced it, and no
    // completion has retired it.
