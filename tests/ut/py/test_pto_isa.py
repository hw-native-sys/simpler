...
def test_assert_pto_isa_root_matches_pin_accepts_matching_head(tmp_path, monkeypatch):
    monkeypatch.setattr(pto_isa, "read_pto_isa_pin", lambda: PIN_A)
    monkeypatch.setattr(pto_isa, "get_pto_isa_head", lambda root: PIN_A)

    pto_isa.assert_pto_isa_root_matches_pin(str(tmp_path / "pto-isa"))


def test_assert_pto_isa_root_matches_pin_rejects_mismatch(tmp_path, monkeypatch):
    monkeypatch.setattr(pto_isa, "read_pto_isa_pin", lambda: PIN_A)
    monkeypatch.setattr(pto_isa, "get_pto_isa_head", lambda root: PIN_B)
