...
protected:
    void SetUp() override {
        ...
        d.worker_count = 3;
        registration = {d.self_address, d.context_generation};
        resident->dev.gm_sm_ptr_ = reinterpret_cast<void *>(d.sm_base);
        resident->dev.prebuilt_arena_base_ = reinterpret_cast<void *>(d.arena_base);
        resident->dev.prebuilt_runtime_offset_ = d.runtime_offset;
