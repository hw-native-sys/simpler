...
# -----------------------------------------------------------------------------------------------------------
"""SPMD Paged Attention Golden - tensormap_and_ringbuffer test (production scale, bfloat16).
...
if __name__ == "__main__":
    run_golden_test(ALL_CASES, DEFAULT_CASE, generate_inputs, label="SPMD Paged Attention")
