 ...
 * Each hardware block owns its workspace region with ping-pong buffers.
 */
...
__attribute__((visibility("default"))) void aicpu_orchestration_entry(const ChipStorageTaskArgs &orch_args) {
    ...
    // GM workspace buffers (×2 for ping-pong between consecutive iterations, per hardware block)
