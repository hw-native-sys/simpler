...
| `SIMPLER_TENSOR_DATA_TIMEOUT_MS` | host platform -> AICPU runtime | ms | per-producer/consumer scalar-wait budget; latched at init, independent of outer watchdog ordering |
